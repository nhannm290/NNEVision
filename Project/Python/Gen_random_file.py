...
def Convert_File_to_Matrix(current_dir = current_dir,path =path,name_file_read="Testfile.txt",name_file_write ="Matrix_Temp.txt"):
...
def Check_File(current_dir = current_dir,path =path,name_file_source="Matrix_temp.txt",name_file_check ="RTL_Result.txt",name_file_result ="Result_Check.txt"):
    ...
    while line_source !="" and line_check != "":
        array_source =line_source.split("\t")
        array_check = line_check.split("\t")
        # print(array_source)
        # print("*"*5)
        # print(array_check)
        # print("*"*5)
